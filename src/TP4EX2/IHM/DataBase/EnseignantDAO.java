...
public class EnseignantDAO {
    ...
    public int AjouterEnseignant(int id,String nom,String prenom,String filiere,String grade)
    {
    ...
    public void RechercherEnseignant(int EnseignantId) throws SQLException {
